"""
Django settings for predatorDetection project.
...
SECRET_KEY = "django-insecure--_mw1__%a17f4!jzozyfr4e6^^m)*xjt0un3#ifcr#!@)3xl5z"
...
WSGI_APPLICATION = "predatorDetection.wsgi.application"
